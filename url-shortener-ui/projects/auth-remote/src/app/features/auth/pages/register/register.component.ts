...
import { SharedInputComponent, SharedButtonComponent, passwordValidator } from '@shared-lib';
...
@Component({
  ...
  styles: [`
    ...
    .auth-card { max-width: 460px; width: 100%; padding: 24px; }
    .auth-form { display: flex; flex-direction: column; margin-top: 16px; }
    .form-actions { margin-top: 8px; }
    .auth-actions { justify-content: center; padding-bottom: 12px; }
  `],
})
