...
import { ObjectSizePipe } from '@shared-lib';
...
@Component({
  ...
  template: `
    <div class="analytics-page">
      <header class="page-header">
        ...
        <a mat-button routerLink="/links" aria-label="Back to links">Back</a>
      </header>
  ...
  styles: [`
    ...
    .range-toggle { margin-bottom: 24px; }
    .kpi-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; margin-bottom: 24px; }
    .kpi-card mat-card-content { display: flex; flex-direction: column; align-items: flex-start; gap: 4px; padding: 20px; }
    .kpi-value { font-size: 1.75rem; font-weight: 700; }
    .kpi-label { color: var(--sys-on-surface-variant, rgba(0, 0, 0, 0.6)); }
    .widgets-grid { display: grid; gap: 16px; margin-bottom: 24px; }
